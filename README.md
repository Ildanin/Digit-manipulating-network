...
beta - momentum conversation parameter

Terminal commands: \
train alpha, cycles, batch_size - trains the nework using stochastic gradient descent \
test - returns accuracy(for recognizer only) and cost \
save filename(optional) - saves the network \
